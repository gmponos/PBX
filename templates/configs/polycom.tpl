...
<APPLICATION APP_FILE_PATH="sip.ld" CONFIG_FILES="{$data[i].mac_address}-lines.cfg, server.cfg, sip.cfg" MISC_FILES="" LOG_FILE_DIRECTORY="" OVERRIDES_DIRECTORY="" CONTACTS_DIRECTORY="" LICENSE_DIRECTORY="">
