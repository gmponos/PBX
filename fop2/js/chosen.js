  ...
  */
  ...
  Chosen = (function() {
    ...
    Chosen.prototype.set_default_values = function() {
      ...
      this.single_temp = new Template('<a href="http://www.fop2.com" onClick="event.returnValue=false; return false;" class="chzn-single"><span>#{default}</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>');
